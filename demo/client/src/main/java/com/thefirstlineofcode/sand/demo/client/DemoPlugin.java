...
public class DemoPlugin implements IPlugin {
	...
	public void init(IChatSystem chatSystem, Properties properties) {
		chatSystem.registerParser(new IqProtocolChain(NotAuthorizedThingRegistration.PROTOCOL),
				new CocParserFactory<>(NotAuthorizedThingRegistration.class));
		chatSystem.registerParser(new IqProtocolChain(ThingRegistration.PROTOCOL),
				new CocParserFactory<>(ThingRegistration.class));
	...
	public void destroy(IChatSystem chatSystem) {
		...
		chatSystem.unregisterParser(new IqProtocolChain(ThingRegistration.PROTOCOL));
		chatSystem.unregisterParser(new IqProtocolChain(NotAuthorizedThingRegistration.PROTOCOL));
	}
