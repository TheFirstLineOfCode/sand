...
@ProtocolObject(namespace="urn:leps:tuxp:concentrator", localName="reset-node")
public class ResetNode {
	public static final Protocol PROTOCOL = new Protocol("urn:leps:tuxp:concentrator", "reset-node");
