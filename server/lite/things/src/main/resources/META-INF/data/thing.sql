...
CREATE TABLE THINGS(id VARCHAR(64) PRIMARY KEY, thing_id VARCHAR(32) NOT NULL, model VARCHAR(16), software_version VARCHAR(16), registration_time TIMESTAMP NOT NULL);
CREATE TABLE THING_IDENTITIES(id VARCHAR(64) PRIMARY KEY, thing_id VARCHAR(32) NOT NULL, thing_name VARCHAR(32) NOT NULL, credentials VARCHAR(16) NOT NULL)
...
CREATE INDEX INDEX_THING_IDENTITIES_THING_NAME ON THING_IDENTITIES (thing_name);
