...
public class LocationService implements ILocationService {
	...
	public String getThingIdByLocation(String location) {
		...
		if (indexOfSlash == -1)
			return thingManager.getThingIdByThingName(location);
		...
		if (RegisteredThing.DEFAULT_RESOURCE_NAME.equals(sLanId)) {
			...
			IConcentrator concentrator = concentratorFactory.getConcentrator(thingManager.getThingIdByThingName(edgeThingName));
